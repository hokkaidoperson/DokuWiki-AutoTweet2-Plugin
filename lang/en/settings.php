...
$lang['template'] = 'Template of the message<br>REPLACEMENT:<br>###WIKITITLE###→The title of this wiki<br>###PAGETITLE###→The title of the edited page<br>###TYPE###→The type of editing ("edited", "reverted", "created", "deleted", or "edited (minor change)" will be shown)<br>###SUMMARY###→The summary of editing<br>###PAGEURL###→The URL leading to the edited page (if there is not ###PAGEURL###, the URL will be automatically added to the last of the template)';
